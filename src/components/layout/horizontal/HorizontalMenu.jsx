...
const HorizontalMenu = ({ dictionary }) => {
  ...
  return (
    ...
    >
      ...
      >
        <MenuItem href={`/${locale}/dashboards`} icon={<i className='ri-pie-chart-2-line' />}>
          Dashboards
        </MenuItem>
        <MenuItem href={`/${locale}/company`} icon={<i className='ri-building-line' />}>
          Company
        </MenuItem>
        <MenuItem href={`/${locale}/agent`} icon={<i className='ri-user-line' />}>
          Agent
        </MenuItem>
        <MenuItem href={`/${locale}/tracking`} icon={<i className='ri-map-pin-user-line' />}>
          Live Tracking
        </MenuItem>
        ...
        <SubMenu label={'Vendor Attendance'} icon={<i className='ri-team-line' />}>
        ...
        <SubMenu label={'Tracking Vendor'} icon={<i className='ri-user-location-line' />}>
