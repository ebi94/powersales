...
import AddVendorDrawer from './AddAgentDrawer'
...
const AgentListTable = ({ customerData }) => {
  // States
  ...
  const columns = useMemo(
    () => [
          ...
          <div className='flex items-center gap-3'>
            ...
            <div className='flex flex-col items-start'>
              <Typography
                component={Link}
                color='text.primary'
                href={getLocalizedUrl(`/agent/details`, locale)}
      ...
      columnHelper.accessor('customerId', {
        header: 'Company',
        cell: ({ row }) => <Typography color='text.primary'>PT ABC Maju Jaya</Typography>
      }),
      columnHelper.accessor('country', {
        header: 'Phone Number',
        cell: ({ row }) => (
          <div className='flex items-center gap-2'>
            <Typography>08128989123</Typography>
          </div>
        )
      }),
